...
class Trainer(object):
    ...
    def __init__(self, args, model, data_num):
        ...
        num_codebooks = len(args.num_emb_list)
        codebook_size = args.num_emb_list[0]
        saved_model_dir = "{}_{}_{}codebook_{}".format(get_local_time(), args.device.replace(":", ""), num_codebooks, codebook_size)
